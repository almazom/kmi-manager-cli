# 🤖 AOP Task List - KMI Manager CLI

**Generated:** 2026-02-02 18:56:00  
**Project:** kmi-manager-cli  
**Confidence Target:** 95%+  
**Experts Consulted:** 🐱 Peter | 🏛️ Rafael | 🔍 QA | 🧹 Maintainability

---

## 🔴 HIGH PRIORITY (Critical - Fix First)
...
├── __init__.py          # Main app router
├── rotate.py            # Rotation commands (--rotate, --auto-rotate)
├── proxy_cmds.py        # Proxy commands (start, stop, restart, logs)
├── status.py            # Status commands (--status, --health)
├── e2e.py               # E2E testing command
...
### TASK-002: Refactor render_accounts_health_dashboard Monster Function ✅ DONE
...
├── routes.py            # Route handlers (split by HTTP method)
...
```
tests/cli/
├── test_rotate_command.py
├── test_proxy_commands.py
...
### TASK-005: Add Coverage Reporting to CI ✅ DONE
**Source:** QA Analysis Report  
...
## 🟡 MEDIUM PRIORITY (Important - Fix This Sprint)
...
### TASK-007: Create Shared Test Fixtures ✅ DONE
**Source:** QA Analysis Report  
**Complexity:** 2 story points  
**Effort:** 1-2 hours
...
### TASK-008: Add Python 3.12 to CI Matrix ✅ DONE
**Source:** QA Analysis Report  
...
### TASK-009: Extract Duplicate Proxy Utilities ✅ DONE
...
### TASK-010: Refactor rotate_manual Complexity [PENDING]
**Source:** Maintainability Report  
**Complexity:** 3 story points  
**Effort:** 3 hours
...
**Effort:** 2 hours  
Convert `Optional[X]` → `X | None` syntax (Python 3.10+)
...
```
Phase 1 (Critical):
├── TASK-001: Split cli.py
├── TASK-002: Refactor dashboard
├── TASK-003: Refactor proxy routes
└── TASK-004: Add CLI tests

Phase 2 (Important):
├── TASK-005: CI coverage
├── TASK-006: Docstrings
├── TASK-007: Test fixtures
└── TASK-008: Python 3.12 CI
...
|--------|------|-------------|
| 🐱 Peter | peter_analysis.md | Architecture well-layered, A- grade |
| 🏛️ Rafael | rafael_architecture.md | YELLOW status, split proxy.py & cli.py |
| 🔍 QA | qa_analysis.md | 98% coverage but 0% on CLI |
| 🧹 Maintainability | maintainability_report.md | Score 62/100, 80 complexity hotspot |
