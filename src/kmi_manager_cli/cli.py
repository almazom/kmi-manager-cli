...
APP_HELP = (
    ...
    "\n"
    "⚠️  IMPORTANT: DRY RUN MODE IS ENABLED BY DEFAULT!\n"
    f"   KMI_DRY_RUN={DEFAULT_KMI_DRY_RUN} (set to 0 for live requests)\n"
    "   The proxy simulates requests by default. Set KMI_DRY_RUN=0 in .env for real traffic.\n"
    "\n"
    "Config defaults:\n"
